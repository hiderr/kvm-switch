...
> ВАЖНО: пуш идёт в `hiderr/kvm-switch` — на этом Mac git/gh должен быть залогинен
> под аккаунтом с правом записи (`hiderr` или коллаборатор). Проверь: `gh auth status`.
